...
namespace PropMan.Controllers
{
    public class PropertiesController : Controller
    {
        ...
        public ActionResult PropertyBox(int? id)
        {
            ...
            {
                Id = property.Id,
                PriceText = property.AdType == AdType.Sale ? $"{Convert.ToInt64(property.SaleUnitPrice) * Convert.ToInt64(property.Area):#,###} تومان" : $"رهن: {property.RentDiposite:#,###} / اجاره: {property.RentMonthly:#,###}",
